...
_This writing is actually a draft note made for myself, so that I myself don’t forget what I had learned. But I think this note will be helpful for those who want to learn Redis. If you don't know what Redis is, or haven't installed Redis in your system yet, check it out here._
